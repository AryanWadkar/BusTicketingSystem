...
async function bookTicket(email, ticketsrc, ticketdest, tickettime, err, next) {
...
async function sendQueueMail(tosend, processresult, orignalrequestdata) {
    ...
    switch (processresult['message']) {
        case "Insufficient balance!":
            mailbody = `<p>We regret to inform you that your ticket booking request was not fulfilled due to the following reason:</p>
...
async function sendTicketMail(tosend, processresult, orignalrequestdata) {
    console.log('mailing started');
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
